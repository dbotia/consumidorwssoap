 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://ProductoWS/", wsdlLocation = "http://localhost:8080/ProveedorWS/NewWebService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://ProductoWS/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ProveedorWS/NewWebService?WSDL");
    ...
    public ProductoWS getProductoWSPort() {
        return super.getPort(new QName("http://ProductoWS/", "ProductoWSPort"), ProductoWS.class);
    }
    ...
    public ProductoWS getProductoWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ProductoWS/", "ProductoWSPort"), ProductoWS.class, features);
    }
